...
function CartItem() {
  return (
    ...
    <div className="">
        <p className='fw-semibold fs-5 text-dark ' variant='dark'>Solar Light 100w Led Top Quality Solar Floodlight Lamp</p>
        <p className='fw-bold text-start fs-4 '>Ksh2600</p>
    </div>
    <div className='mx-1'>
        <BsPlusSquareFill size={40} color={'Red'}/>
    </div>
    <span className='fw-semibold fs-5 text-dark'>3</span>
    <div>
